...
Public Function S_LogEvent(ByVal isOn As Boolean, ByVal wmi As Long) As String
    ...
    End If
End Function
Public Function S_LogDirDisabled(ByVal isOn As Boolean) As String
    If g_Chinese Then
    ...
    End If
End Function
Public Function S_LogPlanHdr(ByVal isOn As Boolean, ByVal d As Long) As String
    If g_Chinese Then
    ...
    End If
End Function
Public Function S_LogSkip(ByVal isOn As Boolean) As String
    If g_Chinese Then
...
End Function
Public Function S_LogCleanRemove(ByVal name As String) As String
    If g_Chinese Then S_LogCleanRemove = "移除顯示裝置：" & name Else S_LogCleanRemove = "CLEAN remove " & name
End Function
Public Function S_LogCleanRemoveRc(ByVal rc As Long) As String
...
End Function
Public Function S_LogCleanTimeout() As String
...
End Function
Public Function S_LogCleanElevate() As String
    If g_Chinese Then S_LogCleanElevate = "清除虛擬顯示卡需要系統管理員權限，正在要求提權…" Else S_LogCleanElevate = "CLEAN elevate…"
End Function
Public Function S_LogCleanElevateFail(ByVal rc As Long) As String
...
End Function
Public Function S_LogProbe(ByVal onN As Long, ByVal sbN As Long) As String
...
End Function
Public Function S_LogManual(ByVal isOn As Boolean) As String
    If g_Chinese Then S_LogManual = "手動啟動" & IIf(isOn, "通電", "斷電") & "流程" Else S_LogManual = "MANUAL " & IIf(isOn, "ON", "OFF")
End Function
Public Function S_LogNativeOffNoPath() As String
...
End Function
Public Function S_LogHdrManual(ByVal turningOn As Boolean) As String
    If g_Chinese Then
    ...
    End If
End Function
Public Function S_LogSettingsSaved() As String
...
Public Function S_LogBalloonToggle(ByVal isOn As Boolean) As String
    If g_Chinese Then
...
Public Function S_TipStandby() As String
    If g_Chinese Then S_TipStandby = "AutoHdrMode：螢幕待命中" Else S_TipStandby = "AutoHdrMode: display STANDBY"
End Function

Public Function S_LogHoldStandby(ByVal onN As Long, ByVal sbN As Long) As String
